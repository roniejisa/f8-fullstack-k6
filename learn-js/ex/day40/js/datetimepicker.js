...
function NewDatePicker(el, settings = {}, eventCallback) {
    this.element = el;
    ...
    this.init = () => {
        ...
        this.eventChooseDone = new Event(eventCallback);
    ...
    this.addEventChooseDay = () => {
        ...
        for (const date of listDate) {
            date.onmousedown = (e) => {
                ...
                this.container.remove();
                this.eventChooseDone.value = `${this.yearChange}/${month}/${dateValue}`;
                this.eventChooseDone.element = this.element;
                window.dispatchEvent(this.eventChooseDone);
            }
        }
    }
