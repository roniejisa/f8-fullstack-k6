...
var _outputCss = require("./assets/output.css");
var _img01Jpg = require("./assets/img/img01.jpg");
...
console.log((0, _configJsonDefault.default));
const App = ()=>{
    return `
        ${(0, _header.Header)()}
        <h2>H\u{1ECD}c l\u{1EAD}p tr\xecnh kh\xf4ng kh\xf3!</h2>
        <h1>Server API: ${(0, _configJsonDefault.default).SERVER_API}</h1>
        <h1>Title: ${(0, _configJsonDefault.default).WEB_TITLE}</h1>
        Th\u{1EDD}i gian: ${(0, _momentDefault.default)().format("dd mm YYYY")}
        <img src="${0, _img01JpgDefault.default}" alt="\u{1EA2}nh 1" />
        ${(0, _footer.Footer)()}
    `;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./components/Footer":"8pPOA","./components/Header":"hsJbF","./assets/output.css":"l8Io2","./assets/img/img01.jpg":"DIAEu","./config.json":"8VeYg","moment":"jwcsj"}],"gkKU3":[function(require,module,exports) {
...
const Header = ()=>{
    return `<Header class="p-4 bg-purple-400">Header</Header>`;
};

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"l8Io2":[function() {},{}],"DIAEu":[function(require,module,exports) {
module.exports = require("1ba38f05e5d5c7d3").getBundleURL("gnRNX") + "img01.8e6f742c.jpg" + "?" + Date.now();

},{"1ba38f05e5d5c7d3":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
module.exports = JSON.parse('{"SERVER_API":"https://api.fullstack.edu.vn","WEB_TITLE":"F8-Fullstack"}');
...
},{}]},["anvqh","gLLPy"], "gLLPy", "parcelRequire1cb5")
